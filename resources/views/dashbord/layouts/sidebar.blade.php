                ...
                <ul class="pt-20 pb-20">
                    ...
                    <li class="mt-18 sub-menu" id="accordionExample">
                       ...
                       <ul 
                            ...
                            <li><a href="{{ route('dashboard') }}" class="sub-menu-children">
                    ...
                    <li class="mt-16">
                        <a href="{{ route('projects.index') }}" class="nav-link-item btn-choose-component">
                            <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <li class="mt-16">
                        <a href="{{ route('tasks.index') }}" class="nav-link-item not-link">
                            <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <li class="mt-16">
                        <a href="{{ route('users.index') }}" class="nav-link-item not-link">
                            <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <li class="mt-16">
                       <form action="{{ route('logout') }}" method="post">
                        @csrf
                        <button type="submit" class="nav-link-item not-link">
                          <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">

						...
						<div class="accordion wrap-task-accordion" id="accordionPanelsStayOpenExample">
                                ...
                                <ul>
                                    ...
                                    <li class="list-task-item">
                                        ...
                                        <label for="task1" class="content-task">
                                            <div class="font-title-btn text-black-2">{{ $task->title }}</div>
                                            <p class="mt-10 body-4 text-black-5 fw-5"><a href="{{ route('tasks.show',$task->id) }}"><i
                                                style="color: #ffc107" class="far fa-eye fa-2xl"></i>&nbsp;</a>
                                                    @if($task->created_by==auth()->user()->id)

                                                    <a href="{{ route('tasks.edit',$task->id) }}"><i
                                                
                                                        style="color: #ffc107" class="fa-solid fa-pen-to-square fa-2xl"></i>&nbsp;</a>
                                                    <a  type="button" data-bs-target="#delete_task{{ $task->id }}" data-bs-toggle="modal"><i
                                                
                                                        style="color: #302727" class="fa-solid fa-trash fa-2xl"></i>&nbsp;</a>
                                                    @endif
                                                </p>
                                           
                                        </label>
                                    </li>
                                    @include('dashbord.tasks.delete_task')
                                    @endforeach
                            ...
                            <div class="accordion-item mt-28">
                                <div class="pb-20 accordion-button header-task" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                    <div class="title-task">
                                        <h6 class="text-black-2">completed Tasks</h6>
                              ...
                              <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                                <ul>
                                    @foreach ($tasks_comleted as $task )
                                        
                                    <li class="list-task-item">
                                        <input type="checkbox" id="task4" class="radio-check success">
                                        <label for="task4" class="content-task">
                                            <div class="font-title-btn text-black-2">{{ $task->title }}</div>
                                            <p class="mt-10 body-4 text-black-5 fw-5"><a href="{{ route('tasks.show',$task_comleted->id) }}"><i
                                                style="color: #ffc107" class="far fa-eye fa-2xl"></i>&nbsp;</a>
                                                <a href="{{ route('tasks.edit',$task->id) }}"><i
                                                    style="color: #ffc107" class="fa-solid fa-pen-to-square fa-2xl"></i>&nbsp;</a>
                                            </p>

...
@section('form_content')
    ...
    <form action="{{ route('tasks.update',$task->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="app-content style-2">
            <div class="tf-container">
                <div class="mt-24">
                    ...
                    <input type="text"  name="title" value="{{ $task->title }}" placeholder="task name" class="mt-16">
                            {{-- namee --}}
          ...
          {{-- end namee --}}
                ...
                <div class="mt-24 list-desc-project-style2">
                    ...
                    <div class="right h9 text-black-5">
                        <input type="text" name="description" value="{{ $task->description }}" placeholder="Add task description">
                                               {{-- namee --}}
        ...
        @endif
          ...
          {{-- start status --}}
          <div class="mt-20">
            <h6 class="text-black-2">Status</h6>
            <div class="d-flex justify-content-between mt-16">
                <div class="col">
                    <label for="inputName" class="control-label">select the Status</label>
                    ...
                    <div class="d-flex justify-content-between mt-16">
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="file"  value="{{ $task->task_image }}"   name="task_image" >
                            </div>
                                                                      {{-- namee --}}
          ...
          {{-- end namee --}}
                ...
                <div class="mt-20">
                    ...
                    <div class="d-flex justify-content-between mt-16">
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="file" value="{{ $task->attachment }}" name="attachment" multiple>
                            </div>
                                                                                 {{-- namee --}}
